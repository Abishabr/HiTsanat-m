...
- [x] 1. Create ThemeContext and ThemeProvider
  ...
  - [x] 1.1 Write property test for toggle round-trip (Property 1)
  ...
  - [x] 1.2 Write property test for DOM class sync (Property 2)
  ...
  - [x] 1.3 Write property test for localStorage persistence round-trip (Property 3)
  ...
  - [x] 1.4 Write property test for system preference fallback (Property 4)
  ...
  - [x] 1.5 Write property test for no CSS mutation (Property 7)
  ...
  - [x] 1.6 Write unit tests for ThemeContext initialization and error handling
...
- [x] 2. Checkpoint — Ensure all ThemeContext tests pass
...
- [x] 3. Create ThemeToggle component
  ...
  - [x] 3.1 Write property test for toggle icon (Property 5)
  ...
  - [x] 3.2 Write property test for aria-label (Property 6)
  ...
  - [x] 3.3 Write unit tests for ThemeToggle
    - Test clicking the toggle calls `toggleTheme`
    - _Requirements: 5.4_

- [x] 4. Wire ThemeProvider into App.tsx
  ...
  - [x] 4.1 Write unit test for ThemeProvider placement
    - Assert `ThemeProvider` wraps `AuthProvider` in the rendered `App` tree
    - _Requirements: 1.3, 6.1_

- [x] 5. Add ThemeToggle to Layout top bar
  ...
  - [x] 5.1 Write unit test for ThemeToggle in Layout
